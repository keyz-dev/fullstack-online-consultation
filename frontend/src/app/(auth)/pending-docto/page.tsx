...
const DoctorApplicationStatusPage = () => {
  ...
  const getStatusDescription = (status: string) => {
    switch (status) {
      case "approved":
        return "Congratulations! Your application has been approved. You can now access your doctor dashboard.";
      case "rejected":
        return "Your application has been rejected. Please review the feedback and consider reapplying.";
      case "under_review":
        return "Your application is currently being reviewed by our team. We'll notify you once a decision is made.";
      default:
        return "Your application has been submitted and is waiting to be reviewed by our team.";
    }
  };
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Track the progress of your doctor application
              </p>
            </div>
          </div>
        </div>
...
export default DoctorApplicationStatusPage;
