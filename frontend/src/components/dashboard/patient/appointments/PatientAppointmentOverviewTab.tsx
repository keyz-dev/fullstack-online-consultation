...
interface PatientAppointmentOverviewTabProps {
  appointment: PatientAppointment;
}

const PatientAppointmentOverviewTab: React.FC<
  PatientAppointmentOverviewTabProps
> = ({ appointment }) => {
      ...
      <div>
        ...
        <div className="bg-green-50 dark:bg-green-900/10 rounded-lg p-4">
          ...
          <div className="space-y-2">
            ...
            {appointment.doctor.specialties &&
              appointment.doctor.specialties.length > 1 && (
                <div className="flex items-center gap-2">
                  <span className="text-sm text-gray-500 dark:text-gray-400">
                    Specialties:{" "}
                    {appointment.doctor.specialties
...
export default PatientAppointmentOverviewTab;
