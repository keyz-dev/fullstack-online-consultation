...
const Step1_BasicUserInfo = () => {
  ...
  const validateForm = () => {
    ...
    if (!pharmacyData.password) {
      newErrors.password = "Password is required";
      isValid = false;
    } else if (pharmacyData.password.length < 6) {
      newErrors.password = "Password must be at least 6 characters";
      isValid = false;
    }

    if (!pharmacyData.confirmPassword) {
      newErrors.confirmPassword = "Please confirm your password";
      isValid = false;
    } else if (pharmacyData.password !== pharmacyData.confirmPassword) {
      newErrors.confirmPassword = "Passwords do not match";
      isValid = false;
    }

    if (
      pharmacyData.phoneNumber &&
      !/^[\+]?[1-9][\d]{0,15}$/.test(
        pharmacyData.phoneNumber.replace(/\s/g, "")
      )
    ) {
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-4">
            <button
              ...
              className={`w-full flex items-center justify-between p-4 rounded-sm border transition-colors ${
                ...
                pharmacyData.address?.coordinates?.lat &&
                pharmacyData.address?.coordinates?.lng
          ...
          <StepNavButtons
            ...
            canContinue={
              ...
              !!pharmacyData.confirmPassword &&
              pharmacyData.password === pharmacyData.confirmPassword
            }
          />
        </div>
      </form>
